...
ActiveRecord::Schema.define(version: 20180826151828) do
  ...
  create_table "like_relationships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["like_id"], name: "index_like_relationships_on_like_id", using: :btree
    t.index ["user_id", "like_id"], name: "index_like_relationships_on_user_id_and_like_id", unique: true, using: :btree
  ...
  add_foreign_key "like_relationships", "microposts", column: "like_id"
